...
- **Free-form workout:** **Start an empty workout**, under the day's title, puts a workout of your own in place of the day's planned session, e.g. at a hotel gym. Give it a name, then add each lift by name as you get to it; the field suggests your plan's lifts and anything you've logged. A lift the plan has brings its sets and reps, how-to notes and knee setting. Log sets as usual, and **Remove from this workout** in a lift's **···** menu takes one out. Progress counts it as an extra session, never as one of the plan's, so the session it replaced still counts as missed. **Back to** (the usual workout) returns to the plan; lifts you logged stay on the day.
