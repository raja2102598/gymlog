      ...
      <Text
        ...
        sub={
          <span id="restNotifStatus" role="status">
            {state === "granted"
              ? "On. While Gym Log is out of sight, your workout’s clock and rest countdown show on the lock screen (in the Now Bar on Samsung), and it tells you when a rest ends."
              : canAsk
